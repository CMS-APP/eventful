...
export default function PrivacyPolicyContent() {
  return (
    <div className="privacy-content flex flex-col gap-2">
      ...
      <p>
        Chris Sharp and Harriet Parsons built Eventful app as a Free app. This
        service is provided by Chris Sharp and Harriet Parsons at no cost and
      ...
      <p>
        ...
        but not limited to email address.
      </p>
      ...
      <p>
        ...
        app when utilising our Service, the time and date of your use of the
      ...
      <p>
        ...
        <a href="mailto:help@eventfulapp.com">help@eventfulapp.com</a>.
      </p>
    </div>
  );
}
