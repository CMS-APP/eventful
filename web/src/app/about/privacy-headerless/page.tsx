    ...
    <div className="flex flex-col min-h-screen bg-[var(--primary)]">
      <main className="flex-grow bg-[var(--primary)] p-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p>
            Chris Sharp and Harriet Parsons built Eventful app as a Free app.
            This service is provided by Chris Sharp and Harriet Parsons at no
          ...
          <h3 className="mt-5">Information Collection and Use</h3>
          ...
          <p>
            ...
            the app when utilising our Service, the time and date of your use of
          ...
          <h3 className="mt-5">Links to Other Sites</h3>
          ...
          <p>This policy is effective as of 2023-06-01.</p>
